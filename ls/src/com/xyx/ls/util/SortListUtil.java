...
public class SortListUtil {
	public static <T> void sortList(List<T> list,  String sortFields, final String sortMode) {  
	    if(list == null || list.size() < 2) {  
	        return;  
	    }  
	    final String sortField;
	    if("dimension".equals(sortFields)){
	     sortField="Dimension";
	    }else{
	    sortField=sortFields;
	    }
//	   sortField.equals("dimension")?"Dimension":sortField;
	        ...
	        public int compare(T o1, T o2) {  
	            try {  
	                ...
	                if(typeName.endsWith("string")) {
	                	if("clickRate".equals(sortField)||"reachRate".equals(sortField)||"convertionRate".equals(sortField)){
	                		Double value1 = Double.parseDouble(v1.toString().substring(0,v1.toString().length()-1));  
		                    Double value2 = Double.parseDouble(v2.toString().substring(0,v2.toString().length()-1));  
		                    return ASC_order ? value1.compareTo(value2) : value2.compareTo(value1);  
	                		
	            		}
	                	String value1;
	                	 String value2;
	                	if(v1==null){value1="";}else{value1 = v1.toString(); }
	                	if(v2==null){value2="";}else{value2 = v2.toString();}
	                    return ASC_order ? value1.compareTo(value2) : value2.compareTo(value1);  
	                }  
...
//	                    Date value2 = (Date)(v2);  
	                    Date value1;
	                    Date value2;
	                	if(v1==null){value1=new Date();}else{value1 = (Date)(v1); }
	                	if(v2==null){value2=new Date();}else{value2 = (Date)(v2);}
	                    return ASC_order ? value1.compareTo(value2) : value2.compareTo(value1);  
	                }  
